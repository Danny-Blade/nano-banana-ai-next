  ...
  pricing: {
    ...
    yearlyPlans: [
      ...
      },
      {
        ...
        period: "/年",
        monthlyEquiv: "折合 $19.99/月",
        saveBadge: "省 $60",
        features: [
          "每年 6,000 积分 + 🎁 赠送1,200积分",
          "基础 AI 模型",
          "高清输出",
          "优先客服支持",
          "PNG 格式下载",
      ...
      },
      {
        ...
        period: "/年",
        monthlyEquiv: "折合 $79.99/月",
        saveBadge: "省 $240",
        features: [
          "每年 24,000 积分 + 🎁 赠送6,000积分",
          "全部 AI 模型",
          "高清输出",
          "批量生成",
          "优先队列",
