  ...
  pricing: {
    ...
    monthlyPlans: [
      ...
      },
      {
        ...
        features: [
          ...
          "PNG format downloads",
          "Commercial license & editing tools",
        ],
        highlighted: true,
      },
      {
        ...
        features: [
          ...
          "Commercial license & advanced tools",
        ],
        highlighted: false,
      },
    ],
    yearlyPlans: [
      ...
      },
      {
        ...
        period: "/year",
        monthlyEquiv: "$15.99/month",
        saveBadge: "Save 20%",
        badge: "🎉 BEST VALUE",
        features: [
          "6,000 credits per year",
          "3,000 high-quality images",
          "Priority generation queue",
          "Priority customer support",
          "PNG format downloads",
          "Commercial license & editing tools",
    ...
    onetimePlans: [
      ...
      },
      {
        ...
        price: "$19.99",
        credits: "2,000",
        monthlyEquiv: "Save 25% vs Starter",
        badge: "💰 BEST VALUE",
        features: [
          "One-time purchase",
          "Credits never expire",
      ...
      },
      {
        ...
        price: "$39.99",
        credits: "5,000",
        monthlyEquiv: "Save 40% vs Starter",
        features: [
          "One-time purchase",
          "Credits never expire",
          "Fastest generation speed",
